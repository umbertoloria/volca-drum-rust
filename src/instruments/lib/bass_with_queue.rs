...
impl BassWithQueue {
    pub fn new(
        ...
        Self {
            stop_note_queue: StopQueueNote::new(),
            instrument,
        }
    }
    ...
    pub fn notify_release_note_at(&mut self, note: &Note, index_1_16th: usize) {
        self.stop_note_queue.enqueue(note, index_1_16th);
    }
    pub fn stop_notes_queued_on_this_1_16th(&mut self, index_1_16th: usize) {
        let notes_to_stop = self.stop_note_queue.dequeue_at(index_1_16th);
